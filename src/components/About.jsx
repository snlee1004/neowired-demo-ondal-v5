...
export default function About() {
  ...
  return (
    <section id="about" className="bg-paper pb-24 pt-20">
      <div className="mx-auto grid max-w-[1140px] items-center gap-12 px-5 md:grid-cols-2">
        <div>
          <h2 className="font-serif text-[36px] font-light leading-snug md:text-[48px]">
            전문의가 이끄는
            <br />
            수준 높은 치과 진료
          </h2>
          <p className="mt-6 text-[16px] font-light leading-relaxed text-ink/80">{clinic.subcopy}</p>
